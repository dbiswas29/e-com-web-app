...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with our customer support team. We\'re here to help with any questions about our products or services.',
  openGraph: {
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">You can track your order by logging into your account and visiting the "Orders" section.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">What is your return policy?</h3>
                  <p className="text-gray-600 text-sm">We offer a 30-day return policy for unused items in their original packaging.</p>
                </div>
                <div>
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">How can I change my order?</h3>
                  <p className="text-gray-600 text-sm">Contact us immediately if you need to change your order. Changes may not be possible if the order has already shipped.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="mt-6 p-4 bg-primary-50 rounded-lg">
                <p className="text-sm text-primary-800">
                  <strong>Emergency Support:</strong> For urgent issues, email us at emergency@ecommerce.com
                </p>
              </div>
            </div>
          </div>
